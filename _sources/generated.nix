...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  gpt4all = {
    pname = "gpt4all";
    version = "20a99d1794a24db7a1322310ba6d63774f569ba4";
    src = fetchFromGitHub {
      owner = "nomic-ai";
      repo = "gpt4all";
      rev = "20a99d1794a24db7a1322310ba6d63774f569ba4";
      fetchSubmodules = true;
      sha256 = "sha256-DRmQC44kEYkzchKV1mc69/06ZcABUY/yl8q1kmDQ7Zc=";
    };
    date = "2024-11-01";
  };
  icat = {
  ...
  wezterm = {
    ...
    cargoLock."Cargo.lock" = {
      lockFile = ./wezterm-c57b3ee28bd4394b2ff2ddf059798d4c84966633/Cargo.lock;
      outputHashes = {
