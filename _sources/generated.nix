...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  gpt4all = {
    pname = "gpt4all";
    version = "9e28dfac9cf4c7c4f7ebd66a75d8c6af107207a8";
    src = fetchFromGitHub {
      owner = "nomic-ai";
      repo = "gpt4all";
      rev = "9e28dfac9cf4c7c4f7ebd66a75d8c6af107207a8";
      fetchSubmodules = true;
      sha256 = "sha256-tOCRQoyZHbtz4WWSYd0fdwziggFLyjNxEI3LbLEqUSI=";
    };
    date = "2023-12-01";
  };
  icat = {
  ...
  wezterm = {
    ...
    cargoLock."Cargo.lock" = {
      lockFile = ./wezterm-bb871b88fd15640bd2c3066e0951f3006ce7846f/Cargo.lock;
      outputHashes = {
