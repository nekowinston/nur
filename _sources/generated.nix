...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  gpt4all = {
    pname = "gpt4all";
    version = "38d92cbb28dc2a47a9d1640d6e3ecfb0791908e1";
    src = fetchFromGitHub {
      owner = "nomic-ai";
      repo = "gpt4all";
      rev = "38d92cbb28dc2a47a9d1640d6e3ecfb0791908e1";
      fetchSubmodules = true;
      sha256 = "sha256-uqBrdn0iFbXyepWDGP1WZD+rHqujXFrkiIpajbFHwHs=";
    };
    date = "2024-12-13";
  };
  icat = {
  ...
  uhk-agent = {
    ...
    version = "5.0.0";
    src = fetchurl {
      url = "https://github.com/UltimateHackingKeyboard/agent/releases/download/v5.0.0/UHK.Agent-5.0.0-linux-x86_64.AppImage";
