...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  gpt4all = {
    pname = "gpt4all";
    version = "26eaf598b4b17dc8458f76e5634da4c7aeb46fac";
    src = fetchFromGitHub {
      owner = "nomic-ai";
      repo = "gpt4all";
      rev = "26eaf598b4b17dc8458f76e5634da4c7aeb46fac";
      fetchSubmodules = true;
      sha256 = "sha256-KZqAZPAaPsckVteqTVoHgdsWoxuW4BDhHQ9+faueqeY=";
    };
    date = "2024-05-03";
  };
  icat = {
  ...
  wezterm = {
    pname = "wezterm";
    version = "ee61e61e4fd6b674b09fa57c96cdce0e7fd939ff";
    src = fetchFromGitHub {
      owner = "wez";
      repo = "wezterm";
      rev = "ee61e61e4fd6b674b09fa57c96cdce0e7fd939ff";
      fetchSubmodules = true;
      sha256 = "sha256-lnbzcAVB1+DB1DoLl6Y7U/nscXxcDWIsd3a5Kh2M8SM=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./wezterm-ee61e61e4fd6b674b09fa57c96cdce0e7fd939ff/Cargo.lock;
      outputHashes = {
