...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  gpt4all = {
    pname = "gpt4all";
    version = "22de3c56bdd4a114ef952b4584dc5d89e4b33150";
    src = fetchFromGitHub {
      owner = "nomic-ai";
      repo = "gpt4all";
      rev = "22de3c56bdd4a114ef952b4584dc5d89e4b33150";
      fetchSubmodules = true;
      sha256 = "sha256-zqkX5jMFM13DjM7s76kBhtIY56GU77pB2b3MVqXSV/A=";
    };
    date = "2023-10-13";
  };
  helm-ls = {
  ...
  wezterm = {
    ...
    cargoLock."Cargo.lock" = {
      lockFile = ./wezterm-11dec45f08e3c7a611f59b030d4a9bd391807604/Cargo.lock;
      outputHashes = {
