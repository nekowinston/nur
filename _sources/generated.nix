...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  gpt4all = {
    pname = "gpt4all";
    version = "41c9013fa46a194b3e4fee6ced1b9d1b65e177ac";
    src = fetchFromGitHub {
      owner = "nomic-ai";
      repo = "gpt4all";
      rev = "41c9013fa46a194b3e4fee6ced1b9d1b65e177ac";
      fetchSubmodules = true;
      sha256 = "sha256-hrWv0F0cZTvNLR736RY7cTDmm7YuFbdIAtKxH5WOhMU=";
    };
    date = "2024-06-06";
  };
  icat = {
  ...
  wezterm = {
    ...
    cargoLock."Cargo.lock" = {
      lockFile = ./wezterm-eb26a5daa1f9ae4d1ff756f165d6b6933e2683f8/Cargo.lock;
      outputHashes = {
